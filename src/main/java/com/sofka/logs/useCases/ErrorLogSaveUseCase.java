...
import com.sofka.logs.models.mongo.ErrorLog;
...
@Validated
@AllArgsConstructor
public class ErrorLogSaveUseCase implements Function<LogDTO, Mono<LogDTO>> {
    private ReactiveMongoTemplate mongoTemplate;
    private ModelMapper modelMapper;

    @Override
    public Mono<LogDTO> apply(LogDTO logDTO) {
        var log = modelMapper.map(logDTO, ErrorLog.class);
