...
import com.sofka.logs.models.mongo.RecordLog;
...
@Validated
@AllArgsConstructor
public class RecordLogSaveUseCase implements Function<LogDTO, Mono<LogDTO>> {
    private ReactiveMongoTemplate mongoTemplate;
    private ModelMapper modelMapper;

    @Override
    public Mono<LogDTO> apply(LogDTO logDTO) {
        var log = modelMapper.map(logDTO, RecordLog.class);
